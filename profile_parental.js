// Pingfence: Parental Control Profile Content Script
...
function theServiceBlocking() {
    ...
    if (
        ...
        showPingfenceOverlay('Access to this site is restricted by your Parental Control settings. If you believe this is an error, please contact your parent or adjust your Pingfence settings.');
    }
}
...
function theSocialBlocking() {
    ...
    if (matchesKeywordPatterns(url, socialBlacklist)) {
        incrementAnalyticsCounter('potentialThreatsBlocked');
        showPingfenceOverlay('Access to social media sites is restricted by your Parental Control settings. If you require access, please contact your parent or adjust your Pingfence settings.');
    }
}
...
function theBankBlocking() {
    ...
    if (matchesKeywordPatterns(url, bankingPhishingBlacklist)) {
        incrementAnalyticsCounter('potentialThreatsBlocked');
        showPingfenceOverlay('This banking or financial site is blocked by your Parental Control settings due to potential risk. If you require access, please contact your parent or adjust your Pingfence settings.');
    }
}
...
// Run all blockers for parental profile
