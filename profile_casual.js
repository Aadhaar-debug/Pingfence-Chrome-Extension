// Pingfence: Casual Profile Content Script
...
function theServiceBlocking() {
	...
	if (
		...
		showPingfenceOverlay('Access to this site is not recommended according to your Casual profile settings. If you believe this is an error, please adjust your Pingfence settings.');
	}
}
...
// Run only theServiceBlocking for casual profile
